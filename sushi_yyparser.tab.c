...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_inout_redir = 24,               /* inout_redir  */
  YYSYMBOL_out_redir = 25,                 /* out_redir  */
...
{
       0,    45,    45,    46,    47,    53,    54,    55,    56,    57,
      58,    61,    62,    65,    66,    69,    70,    73,    74,    77,
      78,    79,    82,    83,    86,    87,    89,    90,    91,    94,
      95,    98,   101,   102,   105
};
#endif
...
static const char *const yytname[] =
{
  ...
  "out_exe", "any_redir", "inout_redir", "out_redir", "in_redir",
...
static const yytype_int8 yydefact[] =
{
      ...
      13,    31,    32,     7,     1,    30,     3,     0,    29,     0,
       0,     0,    14,    21,    20,    19,    24,    25,    33,     0,
      11,    17,    32,     0,     4,    26,    27,    28,    23,    22,
       5,    18,    12
};
...
#line 1119 "sushi_yyparser.tab.c"
    break;

  case 4: /* cmdline: in_exe pipe bg_mode  */
#line 47 "sushi_yyparser.y"
                       {
...
#line 66 "sushi_yyparser.y"
                { (yyval.p) = (yyvsp[-1].p); (yyval.p)->set_redir((yyvsp[0].redir)); }
...
#line 1298 "sushi_yyparser.tab.c"
    break;

  case 33: /* args: args arg  */
#line 102 "sushi_yyparser.y"
           { (yyval.s_vec) = (yyvsp[-1].s_vec);                              (yyval.s_vec)->push_back((yyvsp[0].s)); }
#line 1304 "sushi_yyparser.tab.c"
    break;

  case 34: /* arg: YY_SUSHI_TOK  */
#line 105 "sushi_yyparser.y"
               { (yyval.s) = (yyvsp[0].s); }
#line 1310 "sushi_yyparser.tab.c"
    break;


#line 1314 "sushi_yyparser.tab.c"
