...
{
       0,     0,     3,     4,     7,    11,    15,    17,    20,    22,
      24,    26,    29,    33,    35,    38,    40,    43,    45,    48,
      51,    54,    56,    58,    60,    62,    64,    67,    70,    73,
      74,    76,    78,    80,    83
};
...
{
      18,     0,    -1,    -1,    20,    29,    -1,    21,    19,    29,
      -1,    32,    14,    32,    -1,    13,    -1,     6,    32,    -1,
       8,    -1,     4,    -1,     7,    -1,     5,    22,    -1,    19,
       5,    22,    -1,    30,    -1,    30,    25,    -1,    30,    -1,
      30,    26,    -1,    30,    -1,    30,    24,    -1,    26,    24,
      -1,    24,    26,    -1,    27,    -1,    28,    -1,    26,    -1,
      24,    -1,    23,    -1,    10,    32,    -1,    11,    32,    -1,
      12,    32,    -1,    -1,     3,    -1,    31,    -1,    32,    -1,
      31,    32,    -1,    16,    -1
};
...
{
  "$end", "error", "$undefined", "YY_SUSHI_AMP", "YY_SUSHI_BANG",
  "YY_SUSHI_BAR", "YY_SUSHI_CD", "YY_SUSHI_EXIT", "YY_SUSHI_HISTORY",
  "YY_SUSHI_JOBS", "YY_SUSHI_LESS", "YY_SUSHI_MORE", "YY_SUSHI_MOREMORE",
  "YY_SUSHI_PWD", "YY_SUSHI_SET", "YY_SUSHI_UNKNOWN", "YY_SUSHI_TOK",
  "$accept", "cmdline", "pipe", "redir_exe", "in_exe", "out_exe",
  "inout_redir", "out_redir", "any_redir", "in_redir", "out1_redir",
  "out2_redir", "bg_mode", "exe", "args", "arg", 0
};
#endif
...
#line 43 "sushi_yyparser.y"
    { my_shell.spawn((yyvsp[(1) - (2)].p), (yyvsp[(2) - (2)].b)); ;}
    break;

  case 4:
#line 44 "sushi_yyparser.y"
    { (yyvsp[(1) - (3)].p)->set_pipe((yyvsp[(2) - (3)].p)); my_shell.spawn((yyvsp[(1) - (3)].p), (yyvsp[(3) - (3)].b)); ;}
    break;

  case 5:
#line 45 "sushi_yyparser.y"
    { my_shell.putenv((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].s)); ;}
    break;
...
#line 54 "sushi_yyparser.y"
    { (yyvsp[(3) - (3)].p)->set_pipe((yyvsp[(1) - (3)].p)); (yyval.p) = (yyvsp[(1) - (3)].p); ;}
    break;
...
#line 58 "sushi_yyparser.y"
    { (yyvsp[(1) - (2)].p)->set_redir((yyvsp[(2) - (2)].redir)); (yyval.p) = (yyvsp[(1) - (2)].p); ;}
    break;
...
#line 69 "sushi_yyparser.y"
    { (yyvsp[(2) - (2)].redir).set_in((yyvsp[(1) - (2)].redir)); (yyval.redir) = (yyvsp[(2) - (2)].redir); ;}
    break;

  case 20:
#line 70 "sushi_yyparser.y"
    { (yyvsp[(1) - (2)].redir).set_in((yyvsp[(2) - (2)].redir)); (yyval.redir) = (yyvsp[(1) - (2)].redir); ;}
    break;

  case 21:
#line 73 "sushi_yyparser.y"
    { (yyval.redir) = (yyvsp[(1) - (1)].redir); ;}
    break;
...
#line 81 "sushi_yyparser.y"
    { (yyval.redir).set_in((yyvsp[(2) - (2)].s)); ;}
    break;

  case 27:
#line 82 "sushi_yyparser.y"
    { (yyval.redir).set_out1((yyvsp[(2) - (2)].s)); ;}
    break;

  case 28:
#line 83 "sushi_yyparser.y"
    { (yyval.redir).set_out2((yyvsp[(2) - (2)].s)); ;}
    break;
...
#line 90 "sushi_yyparser.y"
    { (yyval.p) = new Program((yyvsp[(1) - (1)].s_vec)); ;}
    break;

  case 32:
#line 93 "sushi_yyparser.y"
    { (yyval.s_vec) = new std::vector<std::string*>(); (yyval.s_vec)->push_back((yyvsp[(1) - (1)].s)); ;}
    break;

  case 33:
#line 94 "sushi_yyparser.y"
    { (yyvsp[(1) - (2)].s_vec)->push_back((yyvsp[(2) - (2)].s)); (yyval.s_vec) = (yyvsp[(1) - (2)].s_vec); ;}
    break;
...
/* Line 1267 of yacc.c.  */
#line 1533 "sushi_yyparser.tab.c"
      default: break;
    }
